...
function mostrarInicio(){
    document.querySelector("#vistaInicio").style.display = "block";
    document.querySelector("#vistaSubida").style.display = "none";
}

function mostrarSubida(){
    document.querySelector("#vistaInicio").style.display = "none";
    document.querySelector("#vistaSubida").style.display = "block";
}
